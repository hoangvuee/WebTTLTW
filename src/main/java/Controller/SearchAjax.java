...
public class SearchAjax extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Create ProductFilter object and set parameters
        ProductFilter filter = new ProductFilter();
        filter.setSearchQuery(req.getParameter("productName"));
        ...
        filter.setSortOrder(req.getParameter("sortOrder"));

        PrintWriter out = resp.getWriter();

        // Debug log
        System.out.println("Search filter received: " + filter.getSearchQuery());
        ...
        try {
            ListProduct listProduct = serviceProduct.filterProducts(filter);
